...
int s=1;
int snake=0;
int sizeXmin=-1000,sizeXmax=1000, sizeYmin=-800,sizeYmax=800;
int speed=5;
...
void setup()
{
  ...
  for(int i=0;i<1000;i++) 
    pt.add(new PVector(random(sizeXmin, 2*sizeXmax),random(sizeYmin, 2*sizeYmax)));
...
void drawmap() {
  fill(#FFFFF2);
  stroke(255, 0, 0);
  rect(sizeXmin, sizeYmin, sizeXmax*2, sizeYmax*2);
  for (PVector p:pt) {
    noStroke();
    fill(255,255,0);
